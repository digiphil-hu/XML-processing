...
def tsv_from_xml(parsed_xml, xml_path):
    ...
    # Creators
    creators_list = []
    editor_list = ["editor", "TEI-specification", "editor in chief"]
...
# OLAHUS saját path
path_list = ["/home/eltedh/GitHub/nicolaus-olahus-epistulae-pars-II"]
invenio_tsv = "/home/eltedh/PycharmProjects/XML-processing/InvenioRDM/Olahus2/olahus2_invenio_tsv.tsv"
...
for parsed, path in get_filenames(path_list):
    ...
    json_folder = "/home/eltedh/PycharmProjects/XML-processing/InvenioRDM/Olahus2/Olahus_2_json"
