...
def tsv_from_xml(parsed_xml, xml_path):
    ...
    # Creators
    creators_list = []
    editor_list = ["editor", "editor in chief", "TEI-specification"]
    ...
    # Contributors
    # OLAHUS KeyError: Contributors > Emőkének 2 forename-je van + nincs author, nincs ISNI id
    contributors_list = []
    ...
    related_works = [["Is part of", DOI, "DOI", "Dataset"],
                     ...
                     ["Is described by", "https://digiphil.hu/gallery/olahus/", "URL",
                      "Publication"],
...
# OLAHUS saját path
path_list = ["/home/eltedh/GitHub/nicolaus-olahus-epistulae-pars-I"]
invenio_tsv = "olahus_invenio_tsv.tsv"
...
for parsed, path in get_filenames(path_list):
    ...
    json_folder = "/home/eltedh/PycharmProjects/XML-processing/InvenioRDM/Olahus1/Olahus_1_json"
