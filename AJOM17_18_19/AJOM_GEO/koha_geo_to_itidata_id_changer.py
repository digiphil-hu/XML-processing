...
from xml_methods import get_filenames, normalize_whitespaces, get_parent_tags
        ...
        if placename.find("idno"):
            if placename.idno.get("corresp"):
                ...
                if placename_text not in AJOM_geo_dict:
                    ...
                    idno.string = AJOM_geo_dict[placename_text][1]
            else:
                ...
                if placename_text not in AJOM_geo_dict:
                    ...
                    if placename.find("idno"):
                        ...
                        if AJOM_geo_dict[placename_text][0] != "":
                            ...
                            idno_tag.string = placename_text
                        idno_tag["type"] = "ITIdata"
                        placename.append(idno_tag)
        ...
        if koha_geo_idno.get("corresp"):
            ...
            if placename.parent.name != "p" and placename.parent.name != "supplied":
                ...
                if placename_string in AJOM_geo_dict:
                    ...
                    print(placename_string, placename.parent.name, placename.parent.parent.name,
                          placename.parent.parent.parent.name, path)
